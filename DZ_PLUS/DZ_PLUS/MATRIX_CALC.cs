...
namespace DZ_PLUS
{
    ...
    public partial class MATRIX_CALC : Form

    {
        ...
        int[,] secondMatrix;
        int[,] resultMatrix;
        const string firstMatrixFilePath = @"C:\Users\Анна Мамчич\Desktop\PRGRMMNG\c#.net_projekts\DZ_PLUS\DZ_PLUS\First_Matrix.txt";
        const string secondMatrixFilePath = @"C:\Users\Анна Мамчич\Desktop\PRGRMMNG\c#.net_projekts\DZ_PLUS\DZ_PLUS\Second_Matrix.txt";
        public MATRIX_CALC()
        {
            InitializeComponent();
            this.FormClosing += new FormClosingEventHandler(MATRIX_CALC_Closing);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            rowCountForFirstMatrix = Interaction.InputBox("Введіть кількість рядків для першої матриці", "Кількість рядків");
            columnCountForFirstMatrix = Interaction.InputBox("Введіть кількість стовпців для першої матриці", "Кількість стовпців");

            rowCountForSecondMatrix = Interaction.InputBox("Введіть кількість рядків для другої матриці", "Кількість рядків");
            columnCountForSecondMatrix = Interaction.InputBox("Введіть кількість стовпців для другої матриці", "Кількість стовпців");
        ...
        private void MATRIX_CALC_Load(object sender, EventArgs e)
        {

        }
        private void MATRIX_CALC_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
