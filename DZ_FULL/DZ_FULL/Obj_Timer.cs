...
namespace DZ_FULL
{
    public partial class Obj_Timer : Form
    {
        public Obj_Timer()
        {
            InitializeComponent();
            timer1.Interval = 100;
            timer1.Start();
            this.FormClosing += new FormClosingEventHandler(Obj_Timer_FormClosing);
        }
        enum Move
        {
            Right,
        ...
        private void Obj_Timer_FormClosing(object sender, FormClosingEventArgs e)
        {
